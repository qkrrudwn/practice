			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<c:forEach var="pro" items="${list}">
					...
					<tr class="ct_list_pop">
						...
						<td></td>
						<td align="left"><a href="/getProduct.do?prodNo=${pro.prodNo}&menu=${param.menu}">${pro.prodName}</a></td>
						<td></td>
						<td align="left">${pro.getPrice()}</td>
						<td></td>
						<td align="left">${pro.getRegDate()}</td>
						<td></td>
						<td align="left">${pro.getProTranCode()}</td>
					</tr>
					<tr>
